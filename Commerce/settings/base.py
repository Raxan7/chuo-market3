...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.creator_access',
...
MARKETING_EMAIL_BACKEND = os.getenv('MARKETING_EMAIL_BACKEND', '').strip() or EMAIL_BACKEND
MARKETING_EMAIL_HOST = os.getenv('MARKETING_EMAIL_HOST', '').strip() or EMAIL_HOST
MARKETING_EMAIL_PORT = int(os.getenv('MARKETING_EMAIL_PORT', '') or EMAIL_PORT)
MARKETING_EMAIL_HOST_USER = os.getenv('MARKETING_EMAIL_HOST_USER', '').strip() or EMAIL_HOST_USER
MARKETING_EMAIL_HOST_PASSWORD = os.getenv('MARKETING_EMAIL_HOST_PASSWORD', '') or EMAIL_HOST_PASSWORD
MARKETING_EMAIL_USE_SSL = (os.getenv('MARKETING_EMAIL_USE_SSL', '') or str(EMAIL_USE_SSL)).lower() in ('1', 'true', 'yes')
MARKETING_EMAIL_USE_TLS = (os.getenv('MARKETING_EMAIL_USE_TLS', '') or str(EMAIL_USE_TLS)).lower() in ('1', 'true', 'yes')
MARKETING_EMAIL_TIMEOUT = int(os.getenv('MARKETING_EMAIL_TIMEOUT', '') or EMAIL_TIMEOUT)
...
CONTENT_MARKETING_CAMPAIGN_GAP_HOURS = int(os.getenv('CONTENT_MARKETING_CAMPAIGN_GAP_HOURS', '24'))
...
CONTENT_MARKETING_DIGEST_SIZE = int(os.getenv('CONTENT_MARKETING_DIGEST_SIZE', '12'))
MARKETING_EMAIL_POLICY_RETRY_MINUTES = int(os.getenv('MARKETING_EMAIL_POLICY_RETRY_MINUTES', '60'))
MARKETING_EMAIL_POLICY_FAILURE_CIRCUIT_BREAKER = int(os.getenv('MARKETING_EMAIL_POLICY_FAILURE_CIRCUIT_BREAKER', '3'))
